...
function onCardClicked(planet) {
    ...
    //Disable Function
    //Sets pointer events temporarily to none on other planets
    //Sets pointer events temporarily to none restart button
    ...
    //Enables pointer event on to restart button
    ...
    //Adds a timeout of 2000ms to give sufficent time to view the position of images
    function unmatched() {
        disablePointer();
        setTimeout(() => {
